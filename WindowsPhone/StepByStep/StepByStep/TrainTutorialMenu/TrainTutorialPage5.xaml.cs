...
{
    public partial class TrainTutorialPage5 : PhoneApplicationPage
    {
        public TrainTutorialPage5()
        {
            InitializeComponent();
        }
        ...
        {
            NavigationService.Navigate(new Uri("/TrainTutorialMenu/TrainTutorialPage6.xaml", UriKind.Relative));
        }
