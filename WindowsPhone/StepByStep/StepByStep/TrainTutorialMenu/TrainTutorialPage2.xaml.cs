...
{
    public partial class TrainTutorialPage2 : PhoneApplicationPage
    {
        public TrainTutorialPage2()
        {
            InitializeComponent();
        }
        ...
        {
            NavigationService.Navigate(new Uri("/TrainTutorialMenu/TrainTutorialPage1.xaml", UriKind.Relative));
        }
        ...
        {
            NavigationService.Navigate(new Uri("/TrainTutorialMenu/TrainTutorialPage3.xaml", UriKind.Relative));
        }
