...
{
    public partial class OvchipcardTutorialPage6 : PhoneApplicationPage
    {
        public OvchipcardTutorialPage6()
        {
            InitializeComponent();
        }
        ...
        {
            NavigationService.Navigate(new Uri("/OvchipcardTutorialMenu/OvchipcardTutorialPage5.xaml", UriKind.Relative));
        }
        ...
        {
            NavigationService.Navigate(new Uri("/OvchipcardTutorialMenu/OvchipcardTutorialPage7.xaml", UriKind.Relative));
        }
    }
