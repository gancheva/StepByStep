//
//  TrainPopupThreeViewController.m
//  StepByStep
//

#import "TrainPopupThreeViewController.h"

@interface TrainPopupThreeViewController ()
@property (strong, nonatomic) IBOutlet UILabel *bgLabel;
@property (strong, nonatomic) IBOutlet UIScrollView *scrollView;

@end

@implementation TrainPopupThreeViewController
